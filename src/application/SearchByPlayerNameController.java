...
public class SearchByPlayerNameController implements Initializable {
    ...
    @FXML private TextField nameQuery;
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		nameQuery.textProperty().addListener((observable, oldValue, newValue) -> {
